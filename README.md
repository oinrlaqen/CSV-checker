...
This CSV-file Streamlit-made validator checks regular file with employees' insurance coverage info on a bunch of inconsistencies
...
- The first one (***Messed-Up File***) holds number of inconsistencies so that one could seen how each of the checks in this validator works 
